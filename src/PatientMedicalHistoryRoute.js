...
router.post('/medical_history', async (req, res, next) => { //TODO add validation middleware
    db.query("INSERT INTO medical_history(PatientID,Username,Date,Fever,Allergies,XrayURL,Covid_Checked,LabResults,BillStatus,Prescriptions,Insurance_Provider,InsuredStatus,Smoker,Chronic_Pain,Past_Procedures,Weight,Imunizations) VALUES ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
    [   
        req.body.PatientID,
        req.body.Username,
        req.body.Date,
